...
export type TranslationKey =
  ...
  | 'simulator.presetsLabel'
  | 'simulator.preset.budget'
  | 'simulator.preset.budgetTip'
  | 'simulator.preset.speed'
  | 'simulator.preset.speedTip'
  | 'simulator.preset.sovereign'
  | 'simulator.preset.sovereignTip'
