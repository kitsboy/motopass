# Research brief — Bulgaria

**Status:** Researching · **Stale:** 52 days (last checked 2026-07-02) · **Risk:** medium

## Current corpus facts (what we claim today)

- **Bitcoin integration:** Bulgaria offers residency or citizenship pathways with moderate crypto-friendly policy. Bitcoin holders evaluate tax treatment, processing time, and stacking synergy with other jurisdictions.
- **Finance:** min $250000 · typical $400000 · gov fees $15000 · processing 4-10 mo
- **Crypto friendly score:** 7/10 · **Sovereignty:** 5/10 · **Lightning ready:** no
- **Tax:** Standard OECD-aligned framework; specialist planning recommended.
- **Recent changes (on file):** Investor PR thresholds tightened over multiple reforms — BGN 1M company + 10 jobs is current primary tier. Bond route status uncertain in recent amendments; FSC crypto licensing applies to VASP activity. Euro adoption targeted 2025–2026 — monitor BGN peg transition.
