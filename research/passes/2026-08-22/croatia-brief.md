# Research brief — Croatia

**Status:** Researching · **Stale:** 52 days (last checked 2026-07-02) · **Risk:** low

## Current corpus facts (what we claim today)

- **Bitcoin integration:** Croatia offers residency or citizenship pathways with moderate crypto-friendly policy. Bitcoin holders evaluate tax treatment, processing time, and stacking synergy with other jurisdictions.
- **Finance:** min $300000 · typical $450000 · gov fees $18000 · processing 5-10 mo
- **Crypto friendly score:** 5/10 · **Sovereignty:** 7/10 · **Lightning ready:** no
- **Tax:** Standard OECD-aligned framework; specialist planning recommended.
- **Recent changes (on file):** 2026 digital nomad income thresholds indexed to Croatian Bureau of Statistics; Schengen accession expanded mobility for residents.
