# Research brief — New Zealand

**Status:** Researching · **Stale:** 52 days (last checked 2026-07-02) · **Risk:** low

## Current corpus facts (what we claim today)

- **Bitcoin integration:** New Zealand offers residency or citizenship pathways with moderate crypto-friendly policy. Bitcoin holders evaluate tax treatment, processing time, and stacking synergy with other jurisdictions.
- **Finance:** min $2000000 · typical $3000000 · gov fees $50000 · processing 12-24 mo
- **Crypto friendly score:** 4/10 · **Sovereignty:** 9/10 · **Lightning ready:** no
- **Tax:** Standard OECD-aligned framework; specialist planning recommended.
- **Recent changes (on file):** AIP replaced Investor 1/2 visas (2022) at NZD 15M threshold; SMC points settings revised periodically; entrepreneur visa benchmarks tightened — all routes require strong compliance documentation.
